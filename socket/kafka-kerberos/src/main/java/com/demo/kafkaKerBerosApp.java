...
public class kafkaKerberosApp {
    public static void main(String[] args) {
        ...
        if (System.getProperty("java.security.auth.login.config") == null) {
            String jaasPath = findConfigFile("kafka_client_jaas.conf");
            if (jaasPath != null) {
    ...
    private static String findConfigFile(String fileName) {
        ...
        String configPath = basePath + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + fileName;
